...
# %%
df = pd.read_csv('/python_scripts/POINT_20181024_1.csv')
...
with open('/python_scripts/petchaburi.json','r',encoding='utf8') as f:
...
# %%
# write folder
if not os.path.exists('/python_scripts/logs'):
    os.makedirs('/python_scripts/logs')
...
f = open('/python_scripts/logs/stats.json', 'wb')
